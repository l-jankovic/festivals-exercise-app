package com.ftn.modul3.zavrsni.jwd.Festivali.security;
...
//	            .and()
//	            .authorizeRequests()
//	            .antMatchers(HttpMethod.GET,"/api/korisnici/profil/**").hasAnyRole("KORISNIK", "ADMIN") // Pristup samo korisnicima sa ulogom ROLE_ADMIN
//	                .antMatchers(HttpMethod.POST, "/api/korisnici/auth").permitAll() // Putanja za prijavljivanje dostupna svima
//	                .antMatchers(HttpMethod.GET,"/api/izvodjaci").permitAll()
//	                .antMatchers(HttpMethod.GET,"/api/nastupi").permitAll()// Svima
//	                .anyRequest().authenticated();
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://www.MusicFestivals.com", "http://localhost:3000"));
